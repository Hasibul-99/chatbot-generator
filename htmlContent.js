...
const baseUrl = "https://botadmin.sslwireless.com";
var vendorLogo = baseUrl + "/images/vendor_logo.jpg";

{/* <span class="close-btn bot-chat-closed-cici" id="btnClose"></span> */}
    ...
    content: function() {
      ...
      <div id="chatbot" class="main-card collapsed">
        ...
        <div class="input-div">
          ...
          <button class="input-send" id="js-input-send">
